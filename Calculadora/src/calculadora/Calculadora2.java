...
public class Calculadora2 implements CalculadoraI{

   
    
    
	private List<String> stackOperandos;

	/**
	 * Constructor de la clase
	 */
	public Calculadora2(String type) {
		AbstractFactory<String> factory = FactoryProducer.getFactory();
		stackOperandos = factory.getList(type);
	}

	
	public List<String> getMiStack() {
		return stackOperandos;
	}

	
	public void setMiStack(List<String> stackOperandos) {
		this.stackOperandos = stackOperandos;
	}
